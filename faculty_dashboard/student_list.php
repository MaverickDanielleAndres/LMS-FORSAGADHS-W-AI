...
if ($_SESSION['role'] != "faculty") {
	...
	$qur = "SELECT * FROM studentmaster INNER JOIN branchmaster ON studentmaster.StudentBranchCode = branchmaster.BranchCode WHERE StudentBranchCode='$facultyBranch' ORDER BY StudentSemester, StudentFirstName";
