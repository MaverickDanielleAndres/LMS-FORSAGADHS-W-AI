...
if ($_SESSION['role'] != "faculty") {
    ...
    $u = $_SESSION["id"];
    $ssql = "SELECT FacultyFirstName, FacultyLastName FROM facultymaster WHERE FacultyUserName = '$u'";
                            ...
                            function showPreview(event) {
                                ...
                                if (file.files.length > 0) {
                                    ...
                                    if (fsize <= 2000000) {
                                        ...
                                        showCustomAlert('error', 'Upload Error', 'Only images under 2MB are allowed.');
                                        file.value = '';
                                    }
                                }
                            }
...
if (isset($_POST['subbed'])) {
    ...
    $updloadby = $row['FacultyFirstName'] . " " . $row['FacultyLastName'];
    $updtime = date("Y-m-d");
    ...
    if ($run == true) {
        if ($f_error === 0) {
            if ($f_size <= 2000000) {
                ...
                echo "<script>
                    document.addEventListener('DOMContentLoaded', function() {
                        showCustomAlert('error', 'Upload Error', 'File size must be less than 2MB.');
                    });
                </script>";
            ...
            echo "<script>
                document.addEventListener('DOMContentLoaded', function() {
                    showCustomAlert('error', 'Upload Error', 'Something went wrong during file upload!');
                });
            </script>";
        ...
        echo "<script>
                document.addEventListener('DOMContentLoaded', function() {
                    showCustomAlert('success', 'Success', 'Update Added Successfully');
                    setTimeout(function() {
        ...
        echo "<script>
            document.addEventListener('DOMContentLoaded', function() {
                showCustomAlert('error', 'Error', 'Update Not Added');
                setTimeout(function() {
                    window.location.href = 'update_list.php';
                }, 2000);
            });
