	...
	<div class="container-fluid">
		...
		<div class="collapse navbar-collapse" id="sidebarCollapse">
			...
			<ul class="navbar-nav">
				...
				<li class="nav-item">
					<a style="color: white;" href="section_list.php" class="nav-link <?php if ($nav_role == "Student") {
																							echo "active";
																						} ?>">
						<i class="fe uil-user"></i> Sections
					</a>
				</li>
				<!--
				<li class="nav-item">
				...
				<li class="nav-item">
					<a style="color: white;" href="activity_list.php" class="nav-link <?php if ($nav_role == "Written Works") {
						...
						<i class="fe uil-pen"></i> Written Works
					</a>
				</li>
				...
				<li class="nav-item">
					<a style="color: white;" href="quiz_maker.php" class="nav-link <?php if ($nav_role == "Updates") {
																						echo "active";
																					} ?>">
						<i class="fe fe-bell"></i>Quiz Maker
					</a>
				</li>
			...
			<ul class="navbar-nav mb-md-2" style="height:40px;">
				<li class="nav-item">
