...
<?php
	if (isset($_POST['subbed'])) {
		...
		$sql = "INSERT INTO activitymaster (ActivityStatus,ActivityBranch,ActivityTitle, ActivityDesc, ActivitySubject, ActivityUploadedBy, ActivityFile, ActivityUploaddate, ActivityForQuarter, ActivitySubmissionDate, totalscore) 
		...
		document.addEventListener('DOMContentLoaded', function() {
			showCustomPopup('Activity Added Successfully!', 'success', 'Success', 'activity_list.php');
		});
	</script>";
		} else {
			echo "<script>
		document.addEventListener('DOMContentLoaded', function() {
			showCustomPopup('Error Occurred, Activity Not Added', 'error', 'Error', 'add_activity.php');
		});
	</script>";;
		}
		// echo $sql;
