						...
						<form method="POST" autocomplete="off" enctype="multipart/form-data" class="row g-3 needs-validation" >
							...
							<div class="row">
								<div class="col-md-6">
									...
									<input type="number" class="form-control" id="validationCustom01" name="icode" placeholder="20240000" required><br>
								</div>
								<div class="col-md-6">
							...
							<div class="row">
								<div class="col-md-6">
									<label for="validationCustom01" class="form-label">Grade Level</label>
									<input type="text" class="form-control" id="validationCustom01" name="ibranch" value="<?php echo $brow['BranchName']; ?>" readonly><br>
								</div>
								<div class="col-md-6">
									<label for="validationCustom01" class="form-label">Quarter</label>
