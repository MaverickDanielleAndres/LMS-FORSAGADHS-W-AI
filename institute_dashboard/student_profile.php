    ...
    <body>
        ...
        <div class="main-content">
            <div class="header ml-5 mr-5">
                ...
                if (isset($studentenr)) {
                    $sql = "SELECT * FROM studentmaster join branchmaster on studentmaster.StudentBranchCode = branchmaster.BranchCode WHERE StudentEnrollmentNo = '$studentenr';";
                            ...
                            <div class="card center" data-list='{"valueNames": ["name"]}'>
                                <div class="card-body">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <span class="input-group-text col-2 ">Grade Level</span>
