		...
		<div class="main-content">
			<div class="header">
				...
				if (isset($studentenr)) {
					...
					$secrow = mysqli_fetch_assoc($sectionresult);
						...
						<div class="card" data-list='{"valueNames": ["name"]}'>
							<div class="card-body">
								...
								<div class="input-group  input-group-lg mb-3">
									...
									<input class="form-control" value="<?php while ($roww = mysqli_fetch_assoc($xssqlresult)) {
																			echo $roww['SubjectName'] . ", ";
																		} ?>" aria-label="With textarea" disabled>
									<span class="input-group-text col-2 ">Section</span>
									<input type="text" value="<?php echo $secrow['SectionNumber']; ?>" aria-label="Last name" class="form-control" disabled>
								</div>
							</div>
						</div>
					</div>
