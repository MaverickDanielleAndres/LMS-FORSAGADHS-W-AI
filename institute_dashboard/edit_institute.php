...
.header-pretitle{
                     ...
                     <form method="POST" autocomplete="off" enctype="multipart/form-data" class="row g-3 needs-validation">
                           ...
                           <div class="col">
                              <div class="row align-items-center">
                                 <div class="col-auto">
                                    ...
                                    <!-- Avatar -->
                                    <div class="avatar">
                                       <img name="inIMG" class="avatar-img rounded-circle" src="../src/uploads/inprofile/<?php echo $row['InstituteProfilePic'] . "?t"; ?>" alt="..." id="IMG-preview">
                                    </div>
                                 </div>
                                 <div class="col ml-n2">
                                    <!-- Heading -->
                        ...
                        <div class="row">
                           ...
                           <div class="col-12 col-md-6">
                              ...
                              <input oninput="cp()" type="password" class="form-control" id="inpass" name="inpass" value="<?php echo $row['InstitutePassword']; ?>" required>
                           </div>
                        </div>
                        <hr class="md-5">
                        <div class="row">
                        ...
                        <div class="row">
                           <div class="col-12 col-md-6">
                              ...
                              <div class="form-group">
                                 ...
                                 <!-- Input -->
                                 <input type="email" class="form-control" id="validationCustom01" value="<?php echo $row['InstituteEmail']; ?>" name="inemail" required>
                              </div>
                           </div>
                           <div class="col-12 col-md-6">
                              <label for="validationCustom01" class="form-label">
                        ...
                        <div class="row">
                           <div class="col-12 col-md-6">
                              ...
                              <div class="form-group">
                                 ...
                                 <!-- Input -->
                                 <input type="text" class="form-control" value="<?php echo $row['InstituteRole']; ?>" id="validationCustom01" name="inrole" required>
                              </div>
                           </div>
                           <div class="col-12 col-md-6">
                              <label for="validationCustom01" class="form-label">
   ...
   if (isset($_POST['subbed'])) {
      ...
      if ($run == true) {
         ...
         echo "<script>window.open('edit_institute.php?insid=$insid','_self')</script>";
      }
   }
   ?>